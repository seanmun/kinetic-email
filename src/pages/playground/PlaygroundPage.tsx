...
import { FaApple, FaGoogle, FaCopy, FaCode, FaEye, FaChevronDown, FaChevronUp, FaDatabase, FaMagic, FaInfoCircle, FaPaperPlane } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 relative overflow-hidden">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="flex items-center gap-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-3 lg:px-4 py-2 rounded-xl text-xs lg:text-sm font-medium transition-all duration-200 transform hover:scale-105 shadow-lg"
                          >
                            <FaPaperPlane size={12} />
                            <span className="hidden sm:inline">Send to Inbox</span>
      ...
      {generatedHTML && (
        <SendEmailModal
          ...
          defaultSubject="My Kinetic Email Creation"
          emailType="playground"
        />
      )}
    </div>
  );
