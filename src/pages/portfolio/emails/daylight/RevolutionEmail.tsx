...
export const emailMetadata = {
  id: 'revolution',
  name: 'Blue Light Revolution',
  description: 'Brighter Days, Calmer Nights – The Revolution Starts Now',
  subject: "Trouble The Blue Light Revolution: Will You Join Us?",
...
const RevolutionEmail: React.FC = () => {
...
export default RevolutionEmail;