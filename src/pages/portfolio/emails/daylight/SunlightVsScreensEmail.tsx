// src/pages/portfolio/emails/daylight/SunlightVsScreens.tsx
...
export const emailMetadata = {
  id: 'sunlight-vs-screens',
  name: 'Sunlight vs.Screens',
  description: 'ot All Blue Light Is Created Equal',
  subject: "Sunlight vs. Screens: Why Blue Light from Tech is More Toxic",
...
const SunlightVsScreensEmail: React.FC = () => {
...
export default SunlightVsScreensEmail;