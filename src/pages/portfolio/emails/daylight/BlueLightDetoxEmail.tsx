...
export const emailMetadata = {
  id: 'blue-light-detox',
  name: 'Blue Light Detox',
  description: 'Detox Time - 5 Steps to Lighten Your Light Load',
  subject: "Blue Light Detox: Your Action Plan",
...
const BlueLightDetoxEmail: React.FC = () => {
...
export default BlueLightDetoxEmail;